...
public class ProdutoModelAssembler 
	...
	public ProdutoModel toModel(Produto produto) {
		...
		produtoModel.add(algaLinks.linkToRestauranteProdutos(
				produto.getRestaurante().getId(), "produtos"));
		
		produtoModel.add(algaLinks.linkToRestauranteProdutoFoto(
				produto.getRestaurante().getId(), produto.getId(), "fotos"));
