...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private static final String MSG_ERRO_GENERICA_USUARIO_FINAL 
			...
			+ "Tente novamente e se o problema persistir, entre em contato com o "
	...
	private ResponseEntity<Object> handleValidationInternal(Exception ex,
		...
		String detail = "Um ou mais campos estão inválidos. Faça o preenchimento "
	...
	private ResponseEntity<Object> handleNoHandlerFound(NoHandlerFoundException ex,
			HttpHeaders headers, HttpStatus status, WebRequest request) {
	...
	private ResponseEntity<Object> handleMethodArgumentTypeMismatch(
		...
		String detail = String.format("O parâmetro de URL '%s' recebeu o valor '%s', "
				...
				+ "com o tipo %s.", ex.getName(), ex.getValue(), 
	...
	private ResponseEntity<Object> handlePropertyBindingException(
		...
		ProblemType problemType = ProblemType.ERRO_SINTAXE;
		String detail = String.format("A propriedade informada '%s' não existe. "
	...
	public ResponseEntity<?> handleEntidadeNaoEncontrada (
		...
		Problem problem = createProblemBuilder(
				httpStatus, problemType, detail)
				.userMessage("Você não possui permissão para executar esta operação.")
				.build();
