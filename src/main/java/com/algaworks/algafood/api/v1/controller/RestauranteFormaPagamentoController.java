...
public class RestauranteFormaPagamentoController implements RestauranteFormaPagamentoControllerOpenApi {
	...
	public CollectionModel<FormaPagamentoModel> listar(@PathVariable Long restauranteId) {
		...
		if (algaSecurity.podeConsultarFormasDePagamento()) {
			formasPagamentoModel
			.add(algaLinks.linkToRestauranteFormasPagamentoAssociacao(
					restauranteId, "associar"));
			formasPagamentoModel.getContent().forEach(formaPagamentoModel -> {
				formaPagamentoModel.add(algaLinks
						.linkToRestauranteFormasPagamentoDesassociacao(restauranteId,
	...
	public ResponseEntity<Void> desassociar(
		...
		cadastroRestauranteService.desassociarFormaPagamento(
	...
	public ResponseEntity<Void> associar(
		...
		cadastroRestauranteService.associarFormaPagamento(
				restauranteId, formaPagamentoId);
