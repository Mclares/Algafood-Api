...
insert into forma_pagamento (id, descricao, data_atualizacao) values (2, 'cartao de credito', utc_timestamp);
insert into forma_pagamento (id, descricao, data_atualizacao) values (3, 'pix', utc_timestamp);
