...
lock tables cidade write, cozinha write, estado write,
forma_pagamento write, grupo write, grupo_permissao write,
permissao write, produto write, restaurante write,
restaurante_forma_pagamento write, restaurante_usuario_responsavel write,
usuario write, usuario_grupo write, pedido write, item_pedido write,
foto_produto write, oauth_client_details write;
...
values (
  ...
  'READ,WRITE', 'authorization_code', 'http://www.foodanalytics.local:8083', null,
  null, null, null
);
